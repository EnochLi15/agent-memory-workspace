...
当前唯一交付主线是 [V1交付收敛计划](docs/29-V1交付收敛计划.md)：修复交付阻塞、固定发布配置、通过小集闭环与原文对照、完成一次1000题评测，随后封版。当前正在修复交付阻塞，已完成部分代码回归，尚未完成新V1验收；修复证据见 [V1阻塞进展](reports/v1-blocker-followup.md)，实际评测结果见 [第二轮状态](docs/ROUND2-STATUS.md)。
