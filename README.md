...
当前唯一交付主线是 [V1交付收敛计划](docs/29-V1交付收敛计划.md)：修复交付阻塞、固定发布配置、通过小集闭环与原文对照、完成一次1000题评测，随后封版。当前正在修复交付阻塞，已完成部分代码回归，尚未完成新V1验收；修复证据见 [V1阻塞进展](reports/v1-blocker-followup.md)，固定对照见 [小集结果](reports/v1-small-closed-loop.md) 和 [长背景结果](reports/v1-long-33a9e05-results.md)。报告均绑定对应代码版本，后续修复不沿用旧版本成绩。
