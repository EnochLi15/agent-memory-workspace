...
const specPath='configs/round2-source-routing.json',spec=JSON.parse(readFileSync(specPath));
...
for(const parent of ['artifacts/round2-E10-v8-failure-8nr_ipub','artifacts/round2-B05-v8-failure-6arzpegx']){
