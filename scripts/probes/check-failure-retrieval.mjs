...
const config={...configFromEnv({...e,MEMORY_EMBEDDING_DIGEST:'0a109f422b47e3a30ba2b10eca18548e944e8a23073ee3f3e947efcf3c45e59f'}),llmModel:manifest.extraction_model,...(manifest.reasoning_effort&&manifest.reasoning_effort!=='provider_default'?{llmReasoningEffort:manifest.reasoning_effort}:{}),dataDir:join(dir,'data'),port:0};
