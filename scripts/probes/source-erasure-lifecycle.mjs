...
const dir=mkdtempSync(resolve('artifacts/round2-source-lifecycle-')),spec=JSON.parse(readFileSync('configs/round2-quality-source-erasure.json','utf8')),config={...configFromEnv({...parseEnv(readFileSync('.env','utf8')),...spec.defaults}),dataDir:join(dir,'data'),port:0};
