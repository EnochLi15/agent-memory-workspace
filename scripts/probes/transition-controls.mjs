...
const spec=JSON.parse(readFileSync('configs/round2-quality-transitions.json')),config=configFromEnv({...parseEnv(readFileSync('.env','utf8')),...spec.defaults});process.env.MEMORY_MODEL_AUDIT=join(dir,'model-usage.jsonl');
