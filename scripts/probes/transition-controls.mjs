...
import {transitionWork,transitionInput,decodeTransitions,TRANSITION_PROMPT} from '../../service/dist/transitions.js';
const cases=[
...
const input=transitionInput(req,work);
