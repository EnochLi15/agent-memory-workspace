...
当前仍为候选版本。service `b398a63`、eval `b8ae27a` 已通过干净递归克隆、两种模式部署、重启、备份恢复和兼容镜像回退；7502秒托管运行已有验证。长背景阻塞、当前候选固定集、完整评测及最终归档仍需验收。历史归档与旧镜像说明见 [历史部署记录](DEPLOYMENT-HISTORICAL.md)，不能用旧报告证明当前版本已完成。
